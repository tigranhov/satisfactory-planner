...
## 3. Sink node — absorbs items, contributes sink points to global info
...
## 4. Undo / redo for editor actions
...
## 5. Bulk edit on multi-selection
...
- Each bulk operation is one undo entry (per #4).

## 6. Recipe-alternate optimizer
...
## 7. Logistics layer — belt / pipe tier annotations
...
## 9. Import blueprints from a Satisfactory save file
...
- Pairs naturally with bulk edit (#5) — apply tag to all selected.
