...
Run the `/release` skill — it analyzes commits since the last tag, proposes a semver bump, and walks the publish flow end-to-end. See `.claude/skills/release/SKILL.md` for the procedure and `RELEASES.md` for the human-facing reference.
